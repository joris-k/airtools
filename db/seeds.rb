...
tool2 = Tool.new(name: 'Stihl combustion chainsaw', address: 'Bei der Flottbecker Kirche 5, Hamburg', date: '[18-11-2019, 25-11-2019], [25-12-2019, 30-12-2019]', price: 20.75, category: 'Chainsaw', brand: 'Stihl', description: 'Combustion chainsaw with 40cm blade for branches and small to medium trees.', user: User.find_by(first_name: 'Jan', last_name: 'Pillemann Otze'))
